...
# read_predevals_config succeeds, valid yaml file with task id filters
    ...
    Output
      ...
      $eval_sets[[3]]
      $eval_sets[[3]]$eval_set_name
      [1] "Alabama, positive horizons"
      
      $eval_sets[[3]]$round_filters
      $eval_sets[[3]]$round_filters$min
      [1] "2023-01-21"
      
      
      $eval_sets[[3]]$task_filters
      $eval_sets[[3]]$task_filters$location
      [1] "01"
      
      $eval_sets[[3]]$task_filters$horizon
      [1] 1 2 3
